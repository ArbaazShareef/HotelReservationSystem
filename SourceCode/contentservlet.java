...
public class contentservlet extends HttpServlet
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if(fName != null && !fName.isEmpty())
		{
			...
			out.println("<nav><ul><li class=\"\"><a href=\"homeservlet\">Home</a></li>");
		}
		...
		if(productType.equals("H1"))
		{
			...
			out.println("<h3>Trump Hotel</h3>");
            out.println("<article >");
        
            out.println("<br><h3>Location Information</h3><br>");

            out.println("</p>The Trump Hotel is ideally located in the heart of Chicago downtown, and just a short drive to Michigan Lake and Willis Tower. The Art Institute of Chicago, the Millenium park is less than a mile from our hotel."); 

            out.println("<p></p><p>The Trump Hotel can be easily reached by car, taxi or public transport and is located approximately 40 minutes from Chicago's O'Hare International Airport and 30 minutes from Midway International Airport.</p>");
		...
		if(productType.equals("H2"))
		{
			...
			out.println("<h3>Washington Jefferson Hotel</h3>");
            out.println("<article >");
        
        out.println("<br><h3>Location Information</h3><br>");

       out.println("</p>The Washington Jefferson Hotel is ideally located in the heart of Chicago downtown, and just a short drive to Michigan Lake and Willis Tower. The Art Institute of Chicago, the Millenium park is less than a mile from our hotel."); 

out.println("<p></p><p>The Washington Jefferson Hotel can be easily reached by car, taxi or public transport and is located approximately 40 minutes from Chicago's O'Hare International Airport and 30 minutes from Midway International Airport.</p>");
...
out.println("We look forward to welcoming you for your next holidays!");
		...
		{
			out.println("<section id=\"content\">");
			out.println("<h3>Park Lane New York</h3>");
            out.println("<article >");
        
        out.println("<br><h3>Location Information</h3><br>");

       out.println("</p>The Park Lane New York is ideally located in the heart of Chicago downtown, and just a short drive to Michigan Lake and Willis Tower. The Art Institute of Chicago, the Millenium park is less than a mile from our hotel."); 

out.println("<p></p><p>The Park Lane New York can be easily reached by car, taxi or public transport and is located approximately 40 minutes from Chicago's O'Hare International Airport and 30 minutes from Midway International Airport.</p>");
...
out.println("We look forward to welcoming you for your next holidays!");
		...
		out.println("<aside class=\"sidebar\">");
            ...
            out.println("<ul><li><h4>DINING OPTION</h4>");
            out.println("<ul><li><form method='GET' action='filterservlet'>");
            out.println("<div class=\"block form-group\">");
            out.println("<div><input type=\"checkbox\" id=\"CHECKBOX1\"  name='queryCheckBox' value='Breakfast'>");
            
            out.println("<label for=\"CHECKBOX1\"><b>Breakfast<b></label>");
            out.println("</div>");
            
            out.println("</br>");
            
            out.println("<div><input type=\"checkbox\" id=\"CHECKBOX2\" name='queryCheckBox' value='Lunch'>");
            
            out.println("<label for=\"CHECKBOX2\"><b>Lunch<b></label>");
            out.println("</div>");
            
            out.println("</br>");
            
            out.println("<div><input type=\"checkbox\" id=\"CHECKBOX3\" name='queryCheckBox' value='Buffet'>");
            
            out.println("<label for=\"CHECKBOX3\"><b>Buffet<b></label>");
            out.println("</div>");
		...
		out.println("<aside class=\"sidebar\">");
            ...
            out.println("<label for=\"CHECKBOX1\"><b>Chicago<b></label>");
                            ...
                            out.println("<label for=\"CHECKBOX5\"><b>10$ - 20$<b></label>");
							out.println("</div>");
							out.println("</br>");
							
							out.println("<div><input type=\"checkbox\" id=\"CHECKBOX6\">");
							
                            out.println("<label for=\"CHECKBOX6\"><b>50$ - 100$<b></label>");
							out.println("</div>");
							out.println("</br>");
							
							out.println("<div><input type=\"checkbox\" id=\"CHECKBOX7\">");
							
                            out.println("<label for=\"CHECKBOX7\"><b>100$ +<b></label>");
							out.println("</div>");
							out.println("</br>");
