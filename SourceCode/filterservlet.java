...
try{
		...
		if(galleryhotelname[i].equals("HotelOne") ){
		    ...
		    out.println("<a href=#><img style=\"width:300px;height:300px;\" style=\"display:block;\"  src=\"images/");
...
try{
		...
		out.println("<br><br><h2>Hotel Two</h2>");
			HashMap<String,String>images = MySqlDataStoreUtilities.getImages("Washington Jefferson Hotel");
			out.println("<table style=\"width:100%\" style=\"height:100%\" border=\"1\" bordercolor=\"#aaa\" cellspacing=\"0\" cellpadding=\"0\">");
		...
		if(galleryhotelname[i].equals("HotelThree") ){
			...
			HashMap<String,String>images = MySqlDataStoreUtilities.getImages("Park Lane New York");
			out.println("<table style=\"width:100%\" style=\"height:100%\" border=\"1\" bordercolor=\"#aaa\" cellspacing=\"0\" cellpadding=\"0\">");
...
try{
		...
		for(i=0;i<lg;i++){
			...
			if(filters[i].equals("plus")){
				...
				if(filters[i].equals("Presidential")){
				...
				if(filters[i].equals("indian")){

				if(roomType.equals("%")){
					roomType = "Indian Style Spa";
					System.out.println(roomType);
				...
				if(filters[i].equals("fitness")){

				if(roomType.equals("%")){
					roomType = "Fitness Center";
					System.out.println(roomType);
				...
				if(filters[i].equals("kidsclub")){

				if(roomType.equals("%")){
					roomType = "CG Kids Club";
					System.out.println(roomType);
