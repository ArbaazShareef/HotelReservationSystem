...
public class MongoDBDataStoreUtilities
{
	...
	public static void getConnection()
	{
		...
		DB db= mongo.getDB("AlHamdanHotels");
		myReviews= db.getCollection("myReviews");
		myReviews = db.getCollection("myReviews");
		System.out.println("Connection created");
	}
	
	public static void insertReview(String name, String type, double price, String hotelName, String retailerZip, String retailerCity,
	...
	public static HashMap<String, Review> getReviews()
	{
		...
		while (cursor.hasNext())
		{
			...
			Review review = new Review(obj.getString("productName"), obj.getString("productType"), obj.getDouble("productPrice")
										,obj.getString("hotelName"), obj.getString("retailerZip"),obj.getString("retailerCity")
										,obj.getString("retailerState"), obj.getString("productOnSale"), obj.getString("emailId"), obj.getInt("userAge")
